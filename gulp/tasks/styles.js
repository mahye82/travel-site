...
//
// In short, we're taking our original CSS files which contain stuff that is invalid CSS like variables, mixins, nested
// CSS rules (as well as valid CSS like unvendorized styles and import statements). We convert that into valid CSS and
// spew out the valid CSS file into another folder (./app/temp/styles/). That new CSS file is what's used in index.html.
//
